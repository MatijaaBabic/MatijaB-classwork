...
while not done:
    ...
    # above this, or they will be erased with this command.
        if menu == True:
            draw_text("Pong: The Game.", font, WHITE, 900, 100)
            draw_text("Press Space to play", font, WHITE, 900, 400)
            draw_text("Press Escape to play", font, WHITE, 900, 500)
        elif menu == False and game == True:
